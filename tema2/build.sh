...
echo "  ./subscriber 1 10 3 100  # id, subscriptii, brokeri, procent company EQ"
echo "  ./subscriber 2 10 3 100"
echo "  ./subscriber 3 10 3 100"
echo ""
echo "Publisheri:"
echo "  ./publisher 1 10 3 100  # id, publicatii, brokeri, delay_ms"
echo "  ./publisher 2 10 3 100"
echo ""
echo "Runner:"
echo "  bash run_system.sh 3 2 1 10 10"
echo "  bash run_evaluation.sh 3 3 1 180 10000 10"
